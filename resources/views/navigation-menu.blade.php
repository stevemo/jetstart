                ...
                @can('cpanel:view')
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-jet-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button class="flex items-center mt-px text-sm font-medium text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
                                    <div>Cpanel</div>
                            ...
                            <x-slot name="content">
                                @can('viewAny', App\Models\User::class)
                                    <x-jet-dropdown-link href="{{ route('cpanel.users.index') }}">
                                        Users
                                    </x-jet-dropdown-link>
                                @endcan
                            </x-slot>
